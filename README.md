<!-- Full-width centered GIF -->
<div align="center">
  <a href="https://potfile0.io" target="_blank" rel="noopener noreferrer">
    <img src="https://cdn.pfps.gg/banners/9147-dark-n-purple-sky-banner.gif" alt="MasterHead" style="width: 100%; max-width: 100%; height: auto; border-radius: 15px; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.5);"/>
  </a>
</div>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=potfile0&label=Profile%20views&color=0e75b6&style=flat" alt="potfile0" style="border: 2px solid #f5f5f5; border-radius: 10px; padding: 5px; font-size: 16px;"/>
</p>

<!-- About Me Section -->
<div align="center" style="background: linear-gradient(135deg, #333 0%, #555 100%); color: #f5f5f5; padding: 20px; border-radius: 15px; width: 80%; max-width: 700px; margin: 20px auto; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.5);">
  <h3 style="font-family: 'Arial', sans-serif; font-size: 28px; margin: 0;">
    <img src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExaXNxbHJjZDVjMzBobmhkenptODg0cGFrcDgyYng0NHN2djI3MDFzdyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/se6QSoA9i3SnuqOBrm/giphy.webp" width="30" height="30" alt="about me icon" style="vertical-align: middle; margin-right: 10px;">
    About Me
  </h3>
  <p style="font-size: 18px; line-height: 1.6; margin-top: 10px;">
    🌟 **Currently Explored**: Web Assessment, AD Enumeration, Exploitation, and Incident Response.<br>
    🌱 **Learning**: Bash, Web Enumeration, Python, Rust.<br>
    📝 **Active in Cybersecurity**: Keeping up-to-date with the latest news and vulnerabilities.<br>
    🕔 **Hobbies**: Writing scripts, TryHackMe challenges, and CTFs.<br>
    👨‍💻 **Future Goals**: Windows/Linux Privilege Escalation and Security Operations (SOC).<br>
    📄 **Resume**: In progress—stay tuned for updates!
  </p>
</div>
